...
#### Repositories and setting up
 ...
 4. If after adding a new SSH key to your GitHub account, you still cannot push to your own GitHub repository, then you can instead [set up][personalaccesstokens] a personal access tokens. You will use your personal access tokens as your password when doing `git push origin main`. 
...
[personalaccesstokens]: https://www.educative.io/answers/how-to-create-a-personal-access-token-for-github-access
